...
import no.nordicsemi.android.BLE.profile.BleProfileService;
...
public class ProximityService extends BleProfileService implements ProximityManagerCallbacks {
	...
	private final static String ACTION_DISCONNECT = "no.nordicsemi.android.BLE.proximity.ACTION_DISCONNECT";
	...
	protected void onServiceStarted() {
		// logger is now available. Assigne it to the manager
	...
	private void createNotifcation(final int messageResId, final int defaults) {
		final Intent parentIntent = new Intent(this, HRSActivity.class);
